...
***REMOVED***,
  ...
  add: async (values) => ***REMOVED***
    ...
    return Address.updateRelations(***REMOVED*** _id: entry.id, values: relations ***REMOVED***);
***REMOVED***,
  ...
  edit: async (params, values) => ***REMOVED***
    ...
    const entry = await Address.update(params, data, ***REMOVED*** multi: true ***REMOVED***);

    // Update relational data and return the entry.
    return Address.updateRelations(Object.assign(params, ***REMOVED*** values: relations ***REMOVED***));
***REMOVED***,
...
***REMOVED***
    ...
    await Promise.all(
      Address.associations.map(async association => ***REMOVED***
...
***REMOVED***,
  ...
  search: async (params) => ***REMOVED***
    ...
    const $or = Object.keys(Address.attributes).reduce((acc, curr) => ***REMOVED***
      switch (Address.attributes[curr].type) ***REMOVED***
        case 'integer':
        case 'float':
        case 'decimal':
