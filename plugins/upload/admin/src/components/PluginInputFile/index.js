...
class PluginInputFile extends React.PureComponent ***REMOVED***
  state = ***REMOVED*** isDraging: false ***REMOVED***;

  handleChange = (e) => ***REMOVED***
    const dataTransfer = e.target;
    this.props.onDrop(***REMOVED*** dataTransfer ***REMOVED***);
***REMOVED***

  handleDragEnter = () => this.setState(***REMOVED*** isDraging: true ***REMOVED***);
...
***REMOVED***
  ...
  render() ***REMOVED***
    const ***REMOVED***
      ...
      showLoader,
***REMOVED*** = this.props;
    const ***REMOVED*** isDraging ***REMOVED*** = this.state;
    const link = (
...
PluginInputFile.defaultProps = ***REMOVED******REMOVED***;

PluginInputFile.propTypes = ***REMOVED***
