...
***REMOVED***
  ...
  componentWillReceiveProps(nextProps) ***REMOVED***
    ...
    if (nextProps.match.params.env !== this.props.match.params.env) ***REMOVED***
      this.getSettings(nextProps);
***REMOVED***

    // Redirect the user to the upload list after modifying is provider
    if (nextProps.submitSuccess !== this.props.submitSuccess) ***REMOVED***
...
***REMOVED***
  ...
  generateLinks = () => ***REMOVED***
    const headerNavLinks = this.props.appEnvironments.reduce((acc, current) => ***REMOVED***
      const link = Object.assign(current, ***REMOVED*** to: `/plugins/upload/configurations/$***REMOVED***current.name***REMOVED***` ***REMOVED***);
      acc.push(link);
      return acc;
        ...
        <form onSubmit=***REMOVED***this.handleSubmit***REMOVED***>
          <ContainerFluid>
            <PluginHeader
              ...
              description=***REMOVED******REMOVED*** id: 'upload.ConfigPage.description' ***REMOVED******REMOVED***
              title=***REMOVED******REMOVED*** id: 'upload.ConfigPage.title'***REMOVED******REMOVED***
            />
